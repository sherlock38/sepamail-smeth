...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:template match="/">
		...
		<xsl:variable name="senderQXBAN">
			<xsl:value-of select="/sem:Missive/sem:sepamail_missive_001/sem:MsvHdr/sem:Snd" disable-output-escaping="yes"/>
		</xsl:variable>

		<xsl:variable name="receiverQXBAN">
			<xsl:value-of select="/sem:Missive/sem:sepamail_missive_001/sem:MsvHdr/sem:Rcv" disable-output-escaping="yes"/>
		</xsl:variable>
                        ...
                        <rows>
                            <row align="center" class="grid-row">
                                ...
                                <label id="semHdrSummarySenderValue" class="left-align" flex="1">
                                	<xsl:attribute name="value">QXBAN <xsl:value-of select="$senderQXBAN"/></xsl:attribute>
                                </label>
                            </row>
                            <row align="center" class="grid-row">
                        ...
                        <rows>
                            ...
                            <row align="center" class="grid-row">
                                ...
                                <label id="semHdrDetailsReceiverValue">
                                	<xsl:attribute name="value">QXBAN <xsl:value-of select="$receiverQXBAN"/></xsl:attribute>
                                </label>
                            </row>
                        </rows>
                    </grid>
