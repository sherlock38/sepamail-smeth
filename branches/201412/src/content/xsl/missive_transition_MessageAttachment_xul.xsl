...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
        ...
        <xsl:if test="$noAttachments = 1">
            <vbox id="missiveAttachmentContainer">
                <menupopup id="missiveAttachmentListContext" onpopupshowing="return SMETHAttachmentController.onMissiveAttachmentListContextMenuShowing(event);">
                    ...
                    <menuitem id="saveAllMissiveAttachmentListContextMenu" label="Save All..." accesskey="S" oncommand="SMETHAttachmentController.TryHandleMissiveAttachments('saveAll');"/>
                </menupopup>
                <menupopup id="missiveAttachmentListItemContext" onpopuphidding="return SMETHAttachmentController.onMissiveAttachmentListItemContextMenuHidding();" onpopupshowing="return SMETHAttachmentController.onMissiveAttachmentListItemContextMenuShowing();">
                    ...
                    <menuitem id="saveAsMissiveAttachmentListItemContextMenu" label="Save As..." accesskey="S" oncommand="SMETHAttachmentController.TryHandleMissiveAttachments('saveAs', this.parentNode);"/>
                </menupopup>
                ...
                <vbox id="missiveAttachmentView">
                    <hbox align="center" id="missiveAttachmentBar" tooltiptext="Show the attachment pane" onclick="if (event.button == 0) SMETHAttachmentController.toggleMissiveAttachmentList(); event.stopPropagation();">
                        <hbox>
                            <button id="missiveAttachmentToggle" type="checkbox" checkstate="0" onclick="event.stopPropagation();" onmousedown="event.preventDefault();" oncommand="SMETHAttachmentController.toggleMissiveAttachmentList();"/>
                        ...
                        <toolbox id="missiveAttachment-view-toolbox" class="inline-toolbox" defaulticonsize="small" minwidth="50px" defaultlabelalign="end" defaultmode="full" inlinetoolbox="true" mode="full" iconsize="small" labelalign="end">
                            <toolbar id="missiveAttachment-view-toolbar" class="inline-toolbar" customizable="false" mode="full" context="missiveAttachment-toolbar-context-menu" defaulticonsize="small" defaultmode="full" defaultSet="missiveAttachmentSaveAll" iconsize="small">
                                <toolbaritem id="missiveAttachmentSaveAll" removable="false" title="Save As">
                                    <toolbarbutton type="menu-button" id="missiveAttachmentSaveAllSingle" class="toolbarbutton-1 msgHeaderView-button" label="Save" onclick="event.stopPropagation();" oncommand="SMETHAttachmentController.TryHandleMissiveAttachments('saveAs'); SMETHAttachmentController.restoreFocusAfterButton();" tooltiptext="Save the attached file">
                                        <menupopup id="missiveAttachmentSaveAllSingleMenu">
                                            <menuitem id="openMissiveAttachment" label="Open" accesskey="O" oncommand="SMETHAttachmentController.TryHandleMissiveAttachments('open'); event.stopPropagation();"/>
                                            <menuitem id="saveMissiveAttachment" label="Save As..." accesskey="S" oncommand="SMETHAttachmentController.TryHandleMissiveAttachments('saveAs'); event.stopPropagation();"/>
                                        </menupopup>
                                    </toolbarbutton>
                                </toolbaritem>
                            </toolbar>
            ...
            <vbox id="missiveAttachmentContainer">
                ...
                <vbox id="missiveAttachmentView">
                    <hbox align="center" id="missiveAttachmentBar" tooltiptext="Show the attachment pane" onclick="if (event.button == 0) SMETHAttachmentController.toggleMissiveAttachmentList(); event.stopPropagation();">
                        ...
                        <toolbox id="missiveAttachment-view-toolbox" class="inline-toolbox" defaulticonsize="small" minwidth="50px" defaultlabelalign="end" defaultmode="full" inlinetoolbox="true" mode="full" iconsize="small" labelalign="end">
                            <toolbar id="missiveAttachment-view-toolbar" class="inline-toolbar" customizable="false" mode="full" context="missiveAttachment-toolbar-context-menu" defaulticonsize="small" defaultmode="full" defaultSet="missiveAttachmentSaveAll" iconsize="small">
                                <toolbaritem id="missiveAttachmentSaveAll" removable="false" title="Save All">
                                    <toolbarbutton type="menu-button" id="missiveAttachmentSaveAllSingle" class="toolbarbutton-1 msgHeaderView-button" label="Save" onclick="event.stopPropagation();" oncommand="SMETHAttachmentController.TryHandleMissiveAttachments('saveAs'); SMETHAttachmentController.restoreFocusAfterButton();" tooltiptext="Save the attached file">
                                        <menupopup id="missiveAttachmentSaveAllSingleMenu">
                                            <menuitem id="openMissiveAttachment" label="Open" accesskey="O" oncommand="SMETHAttachmentController.TryHandleMissiveAttachments('open'); event.stopPropagation();"/>
                                            <menuitem id="saveMissiveAttachment" label="Save As..." accesskey="S" oncommand="SMETHAttachmentController.TryHandleMissiveAttachments('saveAs'); event.stopPropagation();"/>
    ...
    <xsl:template match="/">
        <xsl:variable name="isTestRequest" select="count(/sem:Missive/sem:sepamail_missive_001/sem:MsvBdy/sem:sepamail_message_001/sem:MsgBdy/sem:SimpleTestRequest)"/>
        <xsl:if test="$isTestRequest = 0">
            <xsl:variable name="isTestReport" select="count(/sem:Missive/sem:sepamail_missive_001/sem:MsvBdy/sem:sepamail_message_001/sem:MsgBdy/sem:SimpleTestReport)"/>
            <xsl:if test="$isTestReport = 0">
            ...
            <xsl:if test="$isTestReport = 1">
                <xsl:variable name="noAttachments" select="count(/sem:Missive/sem:sepamail_missive_001/sem:MsvBdy/sem:sepamail_message_001/sem:MsgBdy/sem:SimpleTestReport/sem:Data)"/>
                <xsl:if test="$noAttachments = 0">
                    <vbox id="missiveAttachmentContainer" collapsed="true"/>
                </xsl:if>
                <xsl:if test="$noAttachments = 1">
                        ...
                        <vbox id="missiveAttachmentView">
                            ...
                            <missiveattachmentlist id="missiveAttachmentList" collapsed="true" context="missiveAttachmentListContext" flex="1" itemcontext="missiveAttachmentListItemContext" orient="horizontal" seltype="multiple" view="small">
                                <missiveattachmentitem size="" imagesize="16" name="Data" tooltiptext="Data">
                                    ...
                                    <data type="" name="Data">
                                        <xsl:value-of disable-output-escaping="yes" select="/sem:Missive/sem:sepamail_missive_001/sem:MsvBdy/sem:sepamail_message_001/sem:MsgBdy/sem:SimpleTestReport/sem:Data"/>
                                    </data>
                                </missiveattachmentitem>
                            </missiveattachmentlist>
                        </vbox>
                ...
                <xsl:if test="$noAttachments > 1">
                    <vbox id="missiveAttachmentContainer">
                        ...
                        <vbox id="missiveAttachmentView">
                            ...
                            <missiveattachmentlist id="missiveAttachmentList" collapsed="true" context="missiveAttachmentListContext" flex="1" itemcontext="missiveAttachmentListItemContext" orient="horizontal" seltype="multiple" view="small">
                                <xsl:for-each select="/sem:Missive/sem:sepamail_missive_001/sem:MsvBdy/sem:sepamail_message_001/sem:MsgBdy/sem:SimpleTestReport/sem:Data">
                                    <missiveattachmentitem size="" imagesize="16">
                                        <xsl:attribute name="name">
