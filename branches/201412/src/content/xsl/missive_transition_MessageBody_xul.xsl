...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:template match="/">
            ...
            <vbox class="request rubis" id="missiveBodyView" flex="1" xmlns="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul">
                <vbox flex="1">
                            ...
                            <grid align="stretch" id="bdyGrid">
                                ...
                                <rows>
                                    <row align="center" class="grid-row">
                                        ...
                                        <datepicker class="request" type="popup" id="semBdyRequestDataValue" disabled="true">
