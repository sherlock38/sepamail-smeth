...
<!--
    Document   : missive_simple_request_transition_MessageBody_xul
    Created on : November 22, 2012, 09:39 AM
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:template match="/">
        <vbox class="request test" id="missiveBodyView" flex="1" xmlns="http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul">
            ...
            <hbox id="semBdy">
                ...
                <vbox flex="1">
                    ...
                    <hbox align="stretch" id="semBdyOperations" pack="start">
                        <button id="semBdyReplyTestRequestButton" disabled="false" label="Reply" oncommand="SMETHReadMessageController.handleReportButtonClick('missive_simple_request_transition_report_xml.xsl');"/>
                    </hbox>
                </vbox>
            </hbox>
        </vbox>
