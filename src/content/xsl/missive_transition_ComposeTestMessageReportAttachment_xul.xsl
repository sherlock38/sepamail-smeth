...
<!--
    Document   : missive_transition_ComposeTestMessageReportAttachment_xul.xsl
    Created on : Febuary 05, 2012, 12:02 PM
    Author     : Bishan Kumar Madhoo <bishan.madhoo@idsoft.mu>
    Description: Transforming a test report missive XML to list of attachments
-->
        ...
        <xsl:if test="$noAttachments = 1">
            <vbox id="missiveAttachmentContainer">
                <menupopup id="missiveAttachmentListContext" onpopupshowing="return SMETHAttachmentController.onMissiveAttachmentListContextMenuShowing(event);">
                    ...
                    <menuitem id="deleteAllMissiveAttachmentListContextMenu" label="Delete" accesskey="D" oncommand="SMETHReportController.TryHandleMissiveAttachments('deleteAllFromTest');"/>
                </menupopup>
                <menupopup id="missiveAttachmentListItemContext" onpopuphidding="return SMETHAttachmentController.onMissiveAttachmentListItemContextMenuHidding();" onpopupshowing="return SMETHAttachmentController.onMissiveAttachmentListItemContextMenuShowing();">
                    ...
                    <menuitem id="deleteMissiveAttachmentListItemContextMenu" label="Delete" accesskey="D" oncommand="SMETHReportController.TryHandleMissiveAttachments('deleteAllFromTest', this.parentNode);"/>
                </menupopup>
                        ...
                        <toolbox id="missiveAttachment-view-toolbox" class="inline-toolbox" defaulticonsize="small" minwidth="50px" defaultlabelalign="end" defaultmode="full" inlinetoolbox="true" mode="full" iconsize="small" labelalign="end">
                            <toolbar id="missiveAttachment-view-toolbar" class="inline-toolbar" customizable="false" mode="full" context="missiveAttachment-toolbar-context-menu" defaulticonsize="small" defaultmode="full" iconsize="small">
                                <toolbaritem id="missiveAttachmentSaveAll" removable="false" title="Delete">
                                    <toolbarbutton type="menu-button" id="missiveAttachmentSaveAllSingle" class="toolbarbutton-1 msgHeaderView-button" label="Delete" onclick="event.stopPropagation();" oncommand="SMETHReportController.TryHandleMissiveAttachments('deleteAllFromTest'); event.stopPropagation();" tooltiptext="Delete the attached file">
                                        <menupopup id="missiveAttachmentSaveAllSingleMenu">
                                            ...
                                            <menuitem id="button-deleteMissiveAttachment" label="Delete" accesskey="D" oncommand="SMETHReportController.TryHandleMissiveAttachments('deleteAllFromTest'); event.stopPropagation();"/>
                                        </menupopup>
                                    </toolbarbutton>
                                </toolbaritem>
                            </toolbar>
        ...
        <xsl:if test="$noAttachments > 1">
            <vbox id="missiveAttachmentContainer">
                <menupopup id="missiveAttachmentListContext" onpopupshowing="return SMETHAttachmentController.onMissiveAttachmentListContextMenuShowing(event);">
                    ...
                    <menuitem id="deleteAllMissiveAttachmentListContextMenu" label="Delete All" accesskey="D" oncommand="SMETHReportController.TryHandleMissiveAttachments('deleteAllFromTest');"/>
                </menupopup>
                <menupopup id="missiveAttachmentListItemContext" onpopuphidding="return SMETHAttachmentController.onMissiveAttachmentListItemContextMenuHidding();" onpopupshowing="return SMETHAttachmentController.onMissiveAttachmentListItemContextMenuShowing();">
                    <menuitem id="openMissiveAttachmentListItemContextMenu" label="Open" accesskey="O" oncommand="SMETHAttachmentController.TryHandleMissiveAttachments('open', this.parentNode);"/>
                    <menuitem id="deleteMissiveAttachmentListItemContextMenu" label="Delete" accesskey="D" oncommand="SMETHReportController.TryHandleMissiveAttachments('deleteAllFromTest', this.parentNode);"/>
                ...
                <vbox id="missiveAttachmentView">
                    <hbox align="center" id="missiveAttachmentBar" tooltiptext="Show the attachment pane" onclick="if (event.button == 0) SMETHAttachmentController.toggleMissiveComposeWindowAttachmentList(); event.stopPropagation();">
                        ...
                        <toolbox id="missiveAttachment-view-toolbox" class="inline-toolbox" defaulticonsize="small" minwidth="50px" defaultlabelalign="end" defaultmode="full" inlinetoolbox="true" mode="full" iconsize="small" labelalign="end">
                            <toolbar id="missiveAttachment-view-toolbar" class="inline-toolbar" customizable="false" mode="full" context="missiveAttachment-toolbar-context-menu" defaulticonsize="small" defaultmode="full" iconsize="small">
                                <toolbaritem id="missiveAttachmentSaveAll" removable="false" title="Delete">
                                    <toolbarbutton type="menu-button" id="missiveAttachmentSaveAllSingle" class="toolbarbutton-1 msgHeaderView-button" label="Delete" onclick="event.stopPropagation();" oncommand="SMETHReportController.TryHandleMissiveAttachments('deleteAllFromTest'); event.stopPropagation();" tooltiptext="Delete the attached files">
                                        <menupopup id="missiveAttachmentSaveAllSingleMenu">
                                            ...
                                            <menuitem id="button-deleteMissiveAttachment" label="Delete All" accesskey="D" oncommand="SMETHReportController.TryHandleMissiveAttachments('deleteAllFromTest'); event.stopPropagation();"/>
                                        </menupopup>
                                    </toolbarbutton>
                                </toolbaritem>
                            </toolbar>
