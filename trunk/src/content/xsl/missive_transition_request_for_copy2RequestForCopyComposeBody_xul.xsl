...
<!--
    Document   : missive_transition_request_for_copy2RequestForCopyComposeBody_xul.xsl
    Created on : May 21, 2013, 03:12 PM
    Author     : Bishan Kumar Madhoo <bishan.madhoo@idsoft.mu>
    Description: Transforming a request.copy@direct.debit XML to message composition XUL interface
-->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:template match="/">
        <vbox class="request gemme" id="missiveBodyView" flex="1">
            <label id="semTestRequestTitle" value="Request for copy details"/>
            ...
            <hbox id="semBdy" flex="1">
                ...
                <vbox align="stretch" flex="1" id="vboxTestRequestDetails">
                    ...
                    <groupbox flex="1" id="groupboxTestRequestContent">
                        <caption id="groupboxTestRequestContentCaption" label="Request for copy content"/>
                        <separator class="thin" orient="horizontal"/>
                        <grid align="stretch" id="gridTestId">
                            ...
                            <rows>
                                <row align="center">
                                    ...
                                    <separator class="thin" orient="vertical"/>
                                    <textbox id="semCreditorReferenceTextbox" flex="1"/>
                                </row>
                                <row align="center">
                                ...
                                <row align="center">
                                    <label id="semDebtorAgentBICLabel" value="Debtor financial institution ID"/>
                                    <separator class="thin" orient="vertical"/>
                                    <textbox id="semDebtorAgentBICTextbox" flex="1"/>
                                </row>
                                <row align="center">
