...
<!--
    Document   : test_transition_message_Generic2GenericComposeBody_xul.xsl
    Created on : April 16, 2013, 10:20 AM
    Author     : Bishan Kumar Madhoo <bishan.madhoo@idsoft.mu>
    Description: Transforming an XML to XUL for composing Agate generic messsages
-->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    <xsl:template match="/">
        <vbox class="request agate" id="missiveBodyView" flex="1">
            <label id="semTestRequestTitle" value="Generic request details"/>
            ...
            <hbox id="semBdy" flex="1">
                ...
                <vbox align="stretch" flex="1" id="vboxTestRequestDetails">
                    ...
                    <groupbox flex="1" id="groupboxTestRequestContent">
                        <caption id="groupboxTestRequestContentCaption" label="Generic request content"/>
                        <separator class="thin" orient="horizontal"/>
                        <grid align="stretch" collapsed="true" id="gridTestId">
                            <columns>
                                <column/>
                                <column/>
                                <column flex="1"/>
                            ...
                            <rows>
                                <row align="center" class="grid-row">
                                    <label id="semBdyTestIdLabel" value="Generic ID"/>
                                    <separator class="thin" orient="vertical"/>
                            ...
                            <button id="semAddTextButton" label="Add text">
                                <xsl:attribute name="oncommand">
                                    <xsl:text disable-output-escaping="yes">
                                        ...
                                        var result = prompts.prompt(null, "SEPAmail generic request", "Generic request text",
